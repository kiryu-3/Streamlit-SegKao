...
def hex_to_hsl(hex_color):
    ...
    scale_first = lambda rgb: int(rgb[0] * 360 / 255)
    hsl_color = scale_first(hsl_color)
    
    return [float(hsl_color[0]), hsl_color[2] * 100, hsl_color[1] * 100]  # 色相、彩度、明度をそれぞれ0-360、0-100、0-100の範囲に変換
